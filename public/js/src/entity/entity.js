...
bq.entity.Entity = cc.PhysicsSprite.extend({
    ...
    showHpGauge: function(maxHp, hp) {
        ...
        rectInner.runAction(new cc.ScaleTo(0.5, currentHpWidth / prevHpWidth, 1));
    ...
    hideHpGauge_: function() {
        ...
        this.hpGauge_.runAction(new cc.Sequence(fadeOut, callFunc));
    },
    ...
    cast: function(data) {
        ...
        rect.runAction(new cc.Sequence(scaleAnim,
            new cc.CallFunc(_.bind(function() {
