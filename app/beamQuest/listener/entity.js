...
var Entity = (function () {
    ...
    Entity.prototype.listen = function (socket, io) {
        ...
        this.socket_ = socket;
        this.io_ = io;
        this.socket_.on('user:position:update', function (data) { return _this.handlePlayerMove_(data); });
        this.socket_.on('user:respawn', function (data) { return _this.handleRespawn(data); });
